...
if  (isset($_POST['submit'])) {
	...
	$sql = "insert into executive_members (name, gender, course, Year_of_study, contact,position, residence, Home_area) 
	values ('$name','$selected_options','$course','$selected_option','$contact','$position','$residence','$Home_area')";
...
<div class="container">
	...
	<option value="Year 5">Year 5</option>
		...
		<div class="form-group">
			...
			<input type="text" name="position" class="form-control" placeholder="Enter position/post held" required>
		</div>
		<div class="form-group">
